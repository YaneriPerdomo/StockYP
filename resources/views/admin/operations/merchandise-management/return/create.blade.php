...
<head>
    ...
    <title>Devolución de Mercancía | <x-systen-name></x-systen-name></title>
...
<body class="h-100 d-flex flex-column">
    ...
    <main class="flex__grow-2 flex-full__aligh-start">
        <form action="{{ route('return-merchandise.store') }}" method="post" class="form w-adjustable">
            ...
            <div class="form__item">
                <label for="note" class="form__label">Motivo de la Salida</label>
                <div class="input-group">
                ...
                @error('note') <div class="alert alert-danger mt-1">{{ $message }}</div>
                @enderror
            </div>
