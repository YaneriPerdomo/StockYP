...
<head>
    ...
    <title>Editar Marca | <x-systen-name></x-systen-name></title>
...
<body class="h-100 d-flex flex-column">
    ...
    <main class="flex__grow-2 flex-full__aligh-start">
        <form action="{{ route('brand.update', $brand->slug) }}" method="post" class="form  w-adjustable-s">
            @csrf
            ...
            <div class="button--back">
                <a href="{{ route('brand.index') }}">
                    ...
                    <button class="button text-grey" type="button">Volver al listado</button>
                </a>
            </div>
            ...
            <div class="form__item">
                <label for="" class="form__label form__label--required">Nombre de la marca</label>
