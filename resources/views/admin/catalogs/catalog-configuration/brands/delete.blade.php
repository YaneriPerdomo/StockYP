        ...
        <article class=" h-100 w-adjustable flex-full__aligh-start  ">
            <div class="card  p-3">
                ...
                <div class="card__message card__message--delete-acount">
                    ...
                    <p>
                        La marca se eliminará permanentemente. Sin embargo, una vez que la elimines, los productos
                        no se asociarán a ninguna marca hasta que selecciones una nueva.
                    </p>
                </div>
                <hr>
                <div class="card__button-option flex-full__justify-content-between ">
                    <a href="{{ route('brand.index') }}" class="text-decoration-white card__link-cancel">
                        <button class="button button--color-grey" type="submit">
                            Cancelar
                        </button>
                    </a>
                    <form action="{{ route('brand.destroy', $slug) }}" method="POST">
                        @method('DELETE')
                        @csrf
