                ...
                <div class="card__message card__message--delete-acount">
                    ...
                    <p>
                        ...
                        @else
                            Esta empleada
                        @endif
                        se eliminará permanentemente, lo que implicará la eliminación de sus registros personales y de usuario. Las actividades que realizaba con su rol de acceso correspondiente ya no serán visibles.
                    </p>
                </div>
                <hr>
                <div class="card__button-option flex-full__justify-content-between ">
                    <a href="{{ route('employee.index') }}" class="text-decoration-white card__link-cancel">
