...
<head>
    ...
    <title>Editar Información del Empleado | <x-systen-name></x-systen-name></title>
...
<body class="h-100 d-flex flex-column">
    ...
    <main class="flex__grow-2 flex-full__aligh-start">
        <form action="{{ route('employee.update', $employee->slug	) }}" method="post" class="form w-adjustable">
            @csrf
            @method('PUT')
            ...
            <legend class="form__title">
                <b>Editar Información {{$employee->gender_id == 1 ? 'del Empleado' : 'de la Empleada'}}</b>
            </legend>
            ...
            <fieldset>
                ...
                <div class="form__item">
                    <label for="employee_user" class="form__label form__label--required">Nombre de Usuario</label>
                    <div class="input-group">
                        ...
                        <input type="text" name="employee_user" id="employee_user"
                            ...
                            aria-label="Nombre del cliente" value="{{ $employee->user->user }}">
                    </div>
                    @error('employee_user') <div class="alert alert-danger mt-1">{{ $message }}</div> @enderror
                </div>
                  ...
                  <div class="form__item ">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="switchCheckDefault">
                                Activ{{ $employee->gender_id == 1 ? 'o' : 'a' }} (La cuenta)  
                            </label>
                        </div>
