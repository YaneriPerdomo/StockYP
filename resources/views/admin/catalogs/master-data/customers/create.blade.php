...
<head>
    ...
    <title>Registar Nuevo Cliente | <x-systen-name></x-systen-name></title>
...
<body class="h-100 d-flex flex-column">
    ...
    <main class="flex__grow-2 flex-full__aligh-start">
        <form action="{{ route('customer.store') }}" method="post" class="form w-adjustable">
            @csrf
            @method('POST')
            ...
            <div class="button--back">
                <a href="{{ route('register.create') }}">
                    ...
                    <button class="button text-grey" type="button">Volver al módulo de registrar nueva venta</button>
                </a>
            </div>

            <legend class="form__title">
                <b>Registar Nuevo Cliente</b>
            </legend>
            ...
            <fieldset>
                <div class="form__item">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="customer_name" id="customer_name"
                            class="form-control @error('customer_name') is-invalid @enderror" placeholder="Ej: Juan"
                            aria-label="Nombre del cliente" value="{{ old('customer_name') }}">
                    </div>
                ...
                <div class="form__item">
                    ...
                    <div class="input-group">
                        <span
                            class="form__icon input-group-text @error('customer_lastname') is-invalid--border @enderror"
                        ...
                        <input type="text" name="customer_lastname" id="customer_lastname"
                            ...
                            placeholder="Ej: Pérez" aria-label="Apellido del cliente" value="{{ old('customer_lastname') }}"> {{-- Assuming
                ...
                <div class="form__item">
                    <label for="phone" class="form__label form__label--required">Número de Teléfono</label>
                    <div class="input-group ">
                        <span
                            class="form__icon input-group-text @error ('phone') is-invalid--border @enderror"
                            id="basic-addon1">
                            <i class="bi bi-telephone"></i> </span>
                        <input type="text" name="phone" id="phone"
                            class="form-control @error ('phone') is-invalid @enderror"
                            placeholder="Ej: 58+ 412-1234567" aria-label="Número de Teléfono"
                            aria-describedby="basic-addon1" value="{{ old('phone') }}">
                    </div>
                    @error('phone')
