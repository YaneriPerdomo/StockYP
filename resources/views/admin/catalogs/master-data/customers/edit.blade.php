...
<head>
    ...
    <title>Editar @if ($customer->gender_id == 1)
        Cliente
    @else
        Clienta
        ...
        <div class="form__item">
            ...
            <div class="input-group">
                ...
                <select class="form-select @error('gender_id') is-invalid @enderror" name="gender_id" id="gender" aria-label="Seleccione el género">
                    ...
                    <option value="2" @if ($customer->gender_id == 2) selected @endif>Femenina</option>
                </select>
            </div>
            @error('gender_id')
...
<div class="form__item">
        ...
        <div class="input-group ">
            <span class="form__icon input-group-text @error ('phone') is-invalid--border @enderror" id="basic-addon1">
