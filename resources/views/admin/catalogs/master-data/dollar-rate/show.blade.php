...
<head>
    ...
    <title>Valor del Dólar | <x-systen-name></x-systen-name></title>
            ...
            <div>
                ...
                <section class="text-center">
                    ...
                    @if (Auth::user()->rol_id == 1)
                        ...
                        <span>
                            @if ($dollar_rate->user_id != null)
                                @if ($dollar_rate->user->employee == [])
                                    {{ 'Administrador(a)' }}
                                @else
                                    @php
                                        if (str_contains($dollar_rate->user->rol->name, ')')) {
                                            echo $dollar_rate->user->employee->name . ' ' . $dollar_rate->user->employee->lastname . ' ' . $dollar_rate->user->rol->name . '';
                                        } else {
                                            echo $dollar_rate->user->employee->name . ' ' . $dollar_rate->user->employee->lastname . ' (' . $dollar_rate->user->rol->name . ')';
                                        }
                                    @endphp
