...
<head>
    ...
    <title>Editar @if ($supplier->gender_id == 1)
        Proveedor
    @else
        Proveedora
...
<body class="h-100 d-flex flex-column">
    ...
    <main class="flex__grow-2 flex-full__aligh-start">
        <form action="{{ route('supplier.update', $supplier->slug) }}" method="post" class="form w-adjustable">
            @csrf
            @method('PUT')
            ...
            <legend class="form__title">
                <b>Editar Información   @if ($supplier->gender_id  == 1)
                         del Proveedor
                    @else
                          de la Proveedora
                    @endif</b>
            ...
            <div class="form__item">
                <label for="name" class="form__label form__label--required">
                    @if ($supplier->gender_id  == 1) Nombre del Proveedor @else Nombre de la Proveedora @endif
                </label>
                ...
                <select class="form-select @error('identity_card_id') is-invalid @enderror" name="identity_card_id"
                    ...
                    @foreach ($identity_cards as $value)
                        <option value="{{ $value->identity_card_id }}"
                            {{ $supplier->identity_card_id == $value->identity_card_id ? 'selected' : '' }}> {{-- Corrected property access --}}
                            {{ $value->identity_card }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form__item">
                ...
                <div class="input-group ">
                    ...
                    <input type="text" name="telephone_number" id="telephone_number"
                        ...
                        aria-describedby="basic-addon1" autofocus value="{{ $supplier->telephone_number }}">
                </div>
            ...
            <div class="form__item">
                ...
                <div class="input-group ">
                    ...
                    <textarea name="address" id="address" rows="2"
                        ...
                        aria-describedby="basic-addon1">{{$supplier->address}}</textarea>
                </div>
             ...
             <div class="form__item ">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="switchCheckDefault">
                                Activ{{ $supplier->gender_id == 1 ? 'o' : 'a' }}
                            </label>
                        </div>
